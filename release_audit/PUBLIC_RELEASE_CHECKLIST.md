...
- [x] Examples copied into public synthetic-data folders.
- [x] Runtime default project changed to `local-runtime`.
- [x] Public docs avoid private operational positioning.
- [x] Final smoke test completed.
